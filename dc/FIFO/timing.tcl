...
if {[sizeof_collection [get_ports clk_wr]] > 0} {
  ...
  set_drive 0 [get_clocks $clk_wr_name] 
}
...
if {[sizeof_collection [get_ports clk_rd]] > 0} {
  ...
  set_drive 0 [get_clocks $clk_rd_name] 
}
#Set clock uncertainty
...
set_dont_touch_network $clk_wr_port 
set_ideal_network $clk_wr_port 
set_dont_touch_network $clk_rd_port 
set_ideal_network $clk_rd_port 
